...
const Erro = ({price,name}) => {
  ...
  {!denuevo && !loading && (
       ...
       <a href="/home" className='absolute top-4 font-bold text-4xl text-gray-300  ml-[400px]'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
